...
README file for the process clone module for Drupal 7.x.

This is a fork of the node clone module. It differs from the baseline module by
presetting the author to the current user and preserving a record of the cloned
nodes' lineage.
